...
from routes import get_customers, get_customer, post_customer, update_customer, delete_customer, delete_all_customers
...
class Mutation:
    ...
    update_customer: List[Customer] = strawberry.field(resolver=resolver_update_customer)
    delete_customer: List[Customer] = strawberry.field(resolver=resolver_delete_customer)
    delete_customers: List[Customer] = strawberry.field(resolver=resolver_delete_customers)
